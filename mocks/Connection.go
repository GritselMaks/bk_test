...
func (_m *Connection) Read() ([]byte, error) {
	ret := _m.Called()
...
// WSConnect provides a mock function with given fields: url
func (_m *Connection) WSConnect(url string) error {
	ret := _m.Called(url)
...
// Write provides a mock function with given fields: messageType, data
func (_m *Connection) Write(messageType int, data []byte) error {
